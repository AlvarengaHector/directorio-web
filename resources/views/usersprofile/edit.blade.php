...
@section('content')
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<div class="thumbnail profile-picture-thumbnail">
					<img class="profile-picture" src="{{ $user->profile->picture_path }}" width="225" onerror="imgError(this);">
			...
			<div class="col-md-8">
				{!! Form::model($profile, ['route' => ['page.profile.update', $profile], 'method' => 'PUT']) !!}
				<div class="jumbotron">
					<div class="container">
		...
		<div class="row">
			...
			{!! Form::model($user, ['route' => ['page.profile.update', $user], 'method' => 'PUT']) !!}
